...
public class CurvedBottomNavigationView extends BottomNavigationView {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mFirstCurveStartPoint.set((mNavigationBarWidth / 2) - ((int)(CURVE_CIRCLE_RADIUS * 1.6)) - (CURVE_CIRCLE_RADIUS / 2), 0);
        // the coordinates (x,y) of the end point after curve
        mFirstCurveEndPoint.set(mNavigationBarWidth / 2, CURVE_CIRCLE_RADIUS + (CURVE_CIRCLE_RADIUS / 6));
        // same thing for the second curve
        mSecondCurveStartPoint = mFirstCurveEndPoint;
        mSecondCurveEndPoint.set((mNavigationBarWidth / 2) + ((int)(CURVE_CIRCLE_RADIUS * 1.6)) + (CURVE_CIRCLE_RADIUS / 2), 0);
        ...
        mFirstCurveControlPoint2.set(mFirstCurveEndPoint.x - ((int)(CURVE_CIRCLE_RADIUS * 2)) + CURVE_CIRCLE_RADIUS, mFirstCurveEndPoint.y);

        mSecondCurveControlPoint1.set(mSecondCurveStartPoint.x + ((int)(CURVE_CIRCLE_RADIUS * 2)) - CURVE_CIRCLE_RADIUS, mSecondCurveStartPoint.y);
        mSecondCurveControlPoint2.set(mSecondCurveEndPoint.x - (CURVE_CIRCLE_RADIUS + (CURVE_CIRCLE_RADIUS / 3)), mSecondCurveEndPoint.y);
    }
