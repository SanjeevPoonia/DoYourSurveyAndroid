...
public class DashboardSurveyResponse {
   ...
   public class Data{
      ...
      public Integer is_shareable;
      @SerializedName("is_attempteable")
      public Integer is_attempteable;
      @SerializedName("refer_applicable")
      public boolean refer_applicable;
      @SerializedName("refer_point")
      public String refer_point;
      @SerializedName("access_survey_cxm")
      public String access_survey_cxm;
